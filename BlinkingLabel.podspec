...
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
  ...
  s.homepage         = 'https://github.com/HariniMurali/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Carey Sam' => 'harini7794@gmail.com' }
  s.source           = { :git => 'https://github.com/HariniMurali/BlinkingLabel.git', :tag => s.version.to_s }
